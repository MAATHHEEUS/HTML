// Lista com os códigos de codifocar e decodificar !!! A ORDEM IMPORTA !!!
let listaCodigos = [
    ['e', 'enter'],
    ['i', 'imes'], 
    ['a', 'ai'],
...
function decodificarTexto() {
    ...
    if(textoEntrada.length == 0 || textoEntrada.trim() == ''){
        alert("Nenhum texto identificado!");
        return;
    }
    // Remove acentos e deixa minusculo
    let textoSemAcentos = removerAcentos(textoEntrada).toLowerCase();
    if(contemCaracterEspecial(textoSemAcentos)){
        alert("Não é permitido caracter especial!")
    }else{
        let textoFinal = textoSemAcentos;
        // Troca os elementos da lista de código para decodificar
...
function codificarTexto() {
    ...
    if(contemCaracterEspecial(textoSemAcentos)){
        ...
        let textoFinal = textoSemAcentos;
        // Troca os elementos da lista de código para codificar
        listaCodigos.forEach(element => {
